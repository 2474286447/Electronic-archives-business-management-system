...
export const routes: AppRoute[] = [
  ...
  { path: '/config', label: '配置中心', permission: null, group: '原型导航' },
  { path: '/config/fonds', label: '全宗管理', permission: null, group: '配置中心' },
  { path: '/config/archive-category', label: '门类管理', permission: null, group: '配置中心' },
